...
void
left008001 (const double *restrict f, int n, int fsi,
	    const double *restrict sigma, int ssi, int ssr, double *restrict fr, int frsi, int frsl)
{
  int i;
...
PyObject *
py_left008001 (PyObject * self, PyObject * args)
{
  double *f, *sigma, *fr;
  ...
  left008001 (f, n, fsi, sigma, ssi, ssr, fr, frsi, frsl);
