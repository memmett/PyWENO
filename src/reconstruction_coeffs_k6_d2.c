void
reconstruction_coeffs_k6_d2(double xi, long int i, int r, double *x, double *c)
{
  ...
  /* p = 3 */
  prod_q = 1.0;
  prod_q *= xi - x[i-r+4];  /* q = 4 */
  prod_q *= xi - x[i-r+5];  /* q = 5 */
  prod_q *= xi - x[i-r+6];  /* q = 6 */
  sum_p += prod_q;

  /* p = 4 */
  prod_q = 1.0;
  prod_q *= xi - x[i-r+3];  /* q = 3 */
  prod_q *= xi - x[i-r+5];  /* q = 5 */
  prod_q *= xi - x[i-r+6];  /* q = 6 */
  sum_p += prod_q;
